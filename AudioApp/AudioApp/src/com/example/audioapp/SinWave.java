...
public class SinWave extends Wave{
    ...
    public void genTone(){   
        ...
        try {
            ...
            audioTrack = new AudioTrack(AudioManager.STREAM_MUSIC,sampleRate,AudioFormat.CHANNEL_OUT_MONO,AudioFormat.ENCODING_PCM_16BIT, PcmArray.length,AudioTrack.MODE_STATIC);
